...
<div class="container">
   ...
   <div class="row">
    ...
    <h2 class="text-warning"><u>Gerer mes recherches pré-enregistrées</u></h2>
    <ul>
      <?php 
...
$requ1=mysql_query("SELECT * FROM recherche WHERE id_ab='$id'");
 ...
 <li>   <div style="width=900px;height:350px;border:1px solid #000;" class="col-md-9"> 
      ...
      <ul>
        ...
        <li><h3 class="text-info">localisation du bien :<h4 class="text-danger"> <?php echo $donne['localite'] ?></h4></h3></li>
     ...
     <div class="col-md-3">
      <a href="recherchenew.php?rechercher=<?php echo $donne['id_recherche'] ?>" class="btn btn-warning" role="button" name="modifier"><span class="glyphicone glyphicon-edit"></span>RECHERCHER</a> <br><br>
      <br><br>   <br><br>   

 <a href="suprecherche.php?sup=<?php echo $donne['id_recherche'] ?>" class="btn btn-danger" role="button" name="supprimer"><span class="glyphicon glyphicon-remove"></span>SUPPRIMER</a>
